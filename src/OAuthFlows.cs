        ...
        public static async Task<string> WaitForCallbackAsync(HttpListener listener, string expectedState, int timeoutMs)
        {
            ...
            try
            {
                ...
                string body = error == null
                    ? "<!doctype html><html lang='uz'><head><meta charset='utf-8'><title>Headroom</title></head><body style='font-family:Segoe UI,sans-serif;text-align:center;padding-top:80px;color:#222;'><h2>Headroom login tugadi</h2><p>Bu tabni yopishingiz mumkin.</p></body></html>"
                    : "<!doctype html><html lang='uz'><head><meta charset='utf-8'><title>Headroom</title></head><body style='font-family:Segoe UI,sans-serif;text-align:center;padding-top:80px;color:#b00;'><h2>Headroom login xatosi</h2><p>" + WebUtility.HtmlEncode(error) + "</p></body></html>";
